**2023/4 - 0 - PROFESSIONAL SOFTWARE DEVELOPMENT**
==================================================
...
* Создать тестовые данные для программы

* Реализовать (де)сериализацию тестовых данных в формате XML

* Реализовать (де)сериализацию тестовых данных в формате JSON

* Исследовать вопрос, каким образом протестировать (де)сериализацию данных

* Измерить производительность различных способов с помощью Benchmarking.NET
...
* Использовать учебную базу данных Northwind (для упрощения задания)

* Подготовить к работе серверы СУБД (SQLite, MS SQL Server, PostgreSQL, MySQL, Oracle Database)

* Построить модель данных средствами EF Core (Database-First для SQLite + MS SQL Server)

* Построить схему данных средствами EF Core (Code-First для PostgreSQL + MySQL + Oracle Database)

* Реализовать операции Create/Read/Update/Delete над данными в БД Northwind средствами EF Core

* Реализовать операции Create/Read/Update/Delete над данными в БД Northwind средствами ADO.NET

* Измерить производительность CRUD-операций (EF Core vs ADO.NET)с помощью Benchmarking.NET

* Исследовать вопрос, каким образом протестировать CRUD-операции над данными под управлением СУБД

* Исследовать продвинутые вопросы взаимодействия с СУБД (транзакции и так далее)

* Создать консольное приложение для выполнения CRUD-операций над БД Northwind
...
* Использовать в качестве примера примитивный API (например, REQRES API)

* Научиться использовать популярные .NET-библиотеки для работы с HTTP-запросами

* Разработать авто-тесты для REQRES API (аналогично предыдущему тестовому заданию)

* Попробовать создать авто-тесты Selenium для веб-сайта REQRES
...
* Использовать один конкретный контекст БД для Northwind (SQLite или MS SQL Server)

* Реализовать REST API для CRUD-операций над БД Northwind (на основе контроллеров + Minimal APIs)

* Исследовать альтернативные стили создания Web API (OData/GraphQL/gRPC - смотри учебные примеры)

* Изучить вопросы генерации спецификации OpenAPI и использования инструментов Swagger
...
* Исследовать использование SignalR с помощью существующих учебных примеров пройденного курса

* Создать примитивное веб-приложение игры "Морской бой" (игра на тетрадном листе в клетку)
...
* Использовать в качестве основы учебные проекты MVC-приложения из пройденного курса

* Исследовать структуру MVC-приложения (модели, представления и контроллеры)

* Исследовать конфигурацию и зависимости MVC-приложения уровня предприятия

* Исследовать продвинутые темы (авторизация, аутентификация, кэширование, безопасность и так далее)

* Расширить функционал учебного проекта (например, добавить что-то похожее, но уже от себя)
...
[Advanced-TODO-Manager](evernote:///view/170957986/s520/bd992bd6-dd94-21d5-657a-c43c71e62137/e61618b5-720a-f21d-017c-b8c2c5756ea8/)
...
**2023/4 - 2.2.1 - Full-Stack Web Development with SPA Frameworks**
===================================================================
...
**2023/4 - 2.2.2 - TypeScript Programming Fundamentals**
========================================================
...
**2023/4 - 2.2.3 - JavaScript Programming (Client & Server)**
=============================================================
...
**2023/4 - 2.3.1 - Python Programming Fundamentals**
====================================================
...
**2023/4 - 2.3.3 - Linux Command Line Scripting**
=================================================
...
**2024? - 1.2.1 - Computer Science - Distributed Systems & Cloud-Native Computing**
===================================================================================
...
**2024? - 1.2.4 - Computer Science - Operating Systems Fundamentals**
=====================================================================
...
* Chapter 3 - Wiring User Interaction and Delivering the Final App
...
**2024? - 2.3.0 - Lua Programming Fundamentals**
================================================
...
**2024? - 2.3.1 - Python Programming Fundamentals**
===================================================
...
**2024? - 2.3.2 - PHP Programming Fundamentals**
================================================
...
**2024? - 2.3.3 - Perl Programming Fundamentals**
=================================================
...
**2024? - 3.1.3.1 - SDLC - Version Control Systems - Git and GitHub**
=====================================================================
...
* [Container Security and Why It Matters | Docker](https://www.docker.com/blog/container-security-and-why-it-matters/)
...
* [How to Use the Resource Usage Docker Extension](https://www.docker.com/blog/how-to-monitor-container-memory-and-cpu-usage-in-docker-desktop/)
...
**2024? - 3.1.6.2 - SDLC - CD/CI Systems - CD/CI with GitHub Actions**
======================================================================
...
**2024? - 3.2.1 - WEB - W3C World Wide Web Standards ( HTML + CSS + JS )**
==========================================================================
...
* 02 - REST API Testing - [Getting Started with REST Testing in SoapUI | SoapUI](https://www.soapui.org/docs/rest-testing/)
...
* Simulate Mobile Devices with Device Mode - [Simulate mobile devices with Device Mode - Chrome Developers](https://developer.chrome.com/docs/devtools/device-mode/)
...
**2024? - 3.2.4.2 - WEB - Networking - Network Traffic Scanning (Nmap)**
========================================================================
...
**2024? - 3.4.1.1 - Hardware & Software - Linux & Unix Operating Systems**
==========================================================================
...
* [Tuning a real-time kernel | Ubuntu](https://ubuntu.com//blog/real-time-kernel-tuning)
...
* [Windows Terminal Preview 1.10 Release - Windows Command Line (microsoft.com)](https://devblogs.microsoft.com/commandline/windows-terminal-preview-1-10-release/)
...
**2024+ | Software Engineering | Software Code Refactoring**
============================================================
