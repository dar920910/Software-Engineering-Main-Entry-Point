# Python - Development Environment - VSCode
...
* [Announcing the new Python Data Science Extension Pack for VS Code - Python](https://devblogs.microsoft.com/python/announcing-the-new-python-data-science-extension-pack-for-vs-code/)
