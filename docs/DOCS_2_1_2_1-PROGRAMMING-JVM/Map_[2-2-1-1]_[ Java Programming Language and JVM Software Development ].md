...
* [Model Data, the Whole Data, and Nothing but the Data - Data-Oriented Programming v1.1](https://inside.java/2024/05/29/dop-v1-1-model-data/)

* [When to use Data-Oriented Programming v1.1](https://inside.java/2024/06/10/dop-v1-1-wrap-up/)

and etc (see links in these articles)

* [Java Visual Studio Code Extension Update](https://inside.java/2024/05/17/vscode-extension-update/)
...
* [Amper Update May 2024 – Standalone Build Tool, New IDE Features, and More](https://blog.jetbrains.com/amper/2024/05/amper-update-may-2024/)
